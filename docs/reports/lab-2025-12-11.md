...
**marneyra/clasificador-tweet-espanol**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/marneyra/clasificador-tweet-espanol)

**sch-allie/opus-finetuned-weblate-en-to-ru**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sch-allie/opus-finetuned-weblate-en-to-ru)

**chunchiliu/Qwen2.5-Coder-3B-Instruct-Gensyn-Swarm-grassy_wary_sealion**

- Type: model
- Research Score: 0.40
- Community Interest: 2 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/chunchiliu/Qwen2.5-Coder-3B-Instruct-Gensyn-Swarm-grassy_wary_sealion)

**thiagoteams/gemma-3-270m-it-vn-demo**

- Type: model
- Research Score: 0.40
- Community Interest: 115 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/thiagoteams/gemma-3-270m-it-vn-demo)
