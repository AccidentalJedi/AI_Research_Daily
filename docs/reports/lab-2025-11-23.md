...
**fpadovani/candor_original_new_67**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/candor_original_new_67)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BenBatton/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-placid_barky_barracuda)

**hanmock/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-amphibious_savage_mantis**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hanmock/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-amphibious_savage_mantis)

**Naphula/Psycho-Test-Suite-GGUFs**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Naphula/Psycho-Test-Suite-GGUFs)

**femboysLover/anime_scoring_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/femboysLover/anime_scoring_model)
...
- fpadovani/candor_original_new_67... (watch for citations and replications)
- BenBatton/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-placid_ba... (watch for citations and replications)
- hanmock/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-amphibious_... (watch for citations and replications)
