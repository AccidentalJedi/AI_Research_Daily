...
**nidaaasif/emotion-bert**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/nidaaasif/emotion-bert)

**Fancylalala/Macaron-A2UI-Grande**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Fancylalala/Macaron-A2UI-Grande)

**boods/Qwen3-14B-FrenchMedical-Multilingual**

- Type: model
- Research Score: 0.40
- Community Interest: 1,229 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/boods/Qwen3-14B-FrenchMedical-Multilingual)
