...
**ONS-AI-RESEARCH/Qwen3-4B-NewsRevision-1112**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ONS-AI-RESEARCH/Qwen3-4B-NewsRevision-1112)

**Aotian12323/ccorgi-dog**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Aotian12323/ccorgi-dog)

**AdoCleanCode/MSR-VTT-shifted-20label-real-severe_kl08-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/MSR-VTT-shifted-20label-real-severe_kl08-model)

**carlynamazed24/wav2vec2-chabacano-stt-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/carlynamazed24/wav2vec2-chabacano-stt-v2)

**gbcfchc/Qwen3-1.7B-Base-Open-Math-On-Policy-Distillation-8K**

- Type: model
- Research Score: 0.40
- Community Interest: 182 downloads, 0 likes
