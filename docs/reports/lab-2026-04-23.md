...
**Kimiist/my_awesome_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kimiist/my_awesome_model)

**paulococato/pavement-defect-classifier**

- Type: model
- Research Score: 0.40
- Community Interest: 27 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/paulococato/pavement-defect-classifier)
...
**hirundo-io/NVIDIA-Nemotron-3-Nano-4B-BF16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hirundo-io/NVIDIA-Nemotron-3-Nano-4B-BF16)

**indiansatoshi/gemma-2-2b-it-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/indiansatoshi/gemma-2-2b-it-GGUF)
