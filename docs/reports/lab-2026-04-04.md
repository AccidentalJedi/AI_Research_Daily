...
- Type: dataset
- Research Score: 0.50
- Community Interest: 18,619 downloads, 257 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/open-index/hacker-news)

**crestai/spark-tts-nexvox_v19**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/crestai/spark-tts-nexvox_v19)

**Cisco1963/llmplasticity-fi_zh_instant_0.125_1-seed42**

- Type: model
- Research Score: 0.40
- Community Interest: 2,928 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Cisco1963/llmplasticity-fi_zh_instant_0.125_1-seed42)

**ppetermann/Ministral-3-14B-Instruct-2512-textonly-NVFP4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ppetermann/Ministral-3-14B-Instruct-2512-textonly-NVFP4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/JFernandoGRE/qwen_bundesversammlung_partylevel_lega_dei_ticinesi)
