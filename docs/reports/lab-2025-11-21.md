...
**septemberendto/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-nimble_scaly_walrus**

- Type: model
- Research Score: 0.40
- Community Interest: 415 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/septemberendto/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-nimble_scaly_walrus)

**chunchiliu/Qwen2.5-Coder-1.5B-Instruct-Gensyn-Swarm-fleecy_waddling_armadillo**

- Type: model
- Research Score: 0.40
- Community Interest: 403 downloads, 0 likes
...
- Type: model
- Research Score: 0.40
- Community Interest: 52 downloads, 2 likes
