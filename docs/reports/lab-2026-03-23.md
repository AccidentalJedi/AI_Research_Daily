...
**newbie87/sarcasm-bert**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/newbie87/sarcasm-bert)

**crestai/spark-tts-nexvox_v10-merged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/crestai/spark-tts-nexvox_v10-merged)

**ddsfvjoisd/Juggernaut-XL-v9**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ddsfvjoisd/Juggernaut-XL-v9)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jendersen/t5-small-finetuned-kernewek-plus-br-cy)

**dany003/odilon-redon-color-period-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dany003/odilon-redon-color-period-lora)
...
- newbie87/sarcasm-bert... (watch for citations and replications)
- crestai/spark-tts-nexvox_v10-merged... (watch for citations and replications)
- ddsfvjoisd/Juggernaut-XL-v9... (watch for citations and replications)
