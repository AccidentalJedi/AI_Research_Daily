...
**maxdcmn/llama-3.2-3B-finetome-2**

- Type: model
- Research Score: 0.40
- Community Interest: 9 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/maxdcmn/llama-3.2-3B-finetome-2)

**image-ssl/vit-s8-lowdim-L6-Lcrop-Gcrop_new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/image-ssl/vit-s8-lowdim-L6-Lcrop-Gcrop_new)

**goke00/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-large_deadly_capybara**

- Type: model
- Research Score: 0.40
- Community Interest: 416 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/goke00/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-large_deadly_capybara)
