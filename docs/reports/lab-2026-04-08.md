...
**VaishnaviGude/jd-generator-full-new**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/VaishnaviGude/jd-generator-full-new)
...
- [🤗 View on HuggingFace](https://huggingface.co/asparius/qwen-insecure-r64-s4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/odats/rl_nmt_2026_04_08_10_56)

**DevQuasar/zai-org.GLM-5.1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 7 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/zai-org.GLM-5.1-GGUF)

**Mohammad-Umer7/ieee-recycling-advisor-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mohammad-Umer7/ieee-recycling-advisor-v1)
