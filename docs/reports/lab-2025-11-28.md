...
**aliorbz/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-scented_exotic_elephant**

- Type: model
- Research Score: 0.40
- Community Interest: 217 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aliorbz/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-scented_exotic_elephant)
