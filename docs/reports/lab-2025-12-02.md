...
**abhirobin/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-sharp_aquatic_newt**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/abhirobin/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-sharp_aquatic_newt)

**Tvisterious/Llama3-2-1B-Instruct-text-to-sql-20K_V2**

- Type: model
- Research Score: 0.40
- Community Interest: 11 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tvisterious/Llama3-2-1B-Instruct-text-to-sql-20K_V2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tfloow/Llama-3.2-1B-adpq-4bit-sim)

**svenschultze/sft-maf_dpo-nomaf_minigrid_model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/svenschultze/sft-maf_dpo-nomaf_minigrid_model)

**Tvisterious/Llama3-2-1B-Instruct-text-to-sql-20K**

- Type: model
- Research Score: 0.40
- Community Interest: 50 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Tvisterious/Llama3-2-1B-Instruct-text-to-sql-20K)
