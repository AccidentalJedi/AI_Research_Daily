...
**mlkro/Llama-3.2-1B-Instruct-HI-SynthDolly-3B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mlkro/Llama-3.2-1B-Instruct-HI-SynthDolly-3B)

**lingshanCeR/bee-xthn**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lingshanCeR/bee-xthn)
...
- mlkro/Llama-3.2-1B-Instruct-HI-SynthDolly-3B... (watch for citations and replications)
- lingshanCeR/bee-xthn... (watch for citations and replications)
