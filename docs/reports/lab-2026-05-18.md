...
**mradermacher/spikingkiki-122b-a10b-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 17,929 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/spikingkiki-122b-a10b-i1-GGUF)

**Bedru/FTwhisper-small-wello**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bedru/FTwhisper-small-wello)

**shiningstar1128/new-trainer-v01**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/shiningstar1128/new-trainer-v01)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/schneewolflabs/A1)
...
- [🤗 View on HuggingFace](https://huggingface.co/3tic/Orion-Qwen3-4B-CPT-v2605)
...
- mradermacher/spikingkiki-122b-a10b-i1-GGUF... (watch for citations and replications)
- Bedru/FTwhisper-small-wello... (watch for citations and replications)
- shiningstar1128/new-trainer-v01... (watch for citations and replications)
