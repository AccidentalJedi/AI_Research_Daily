...
- [🤗 View on HuggingFace](https://huggingface.co/ohjayy/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-prowling_snorting_buffalo)

**gbcfchc/Qwen2.5-Math-1.5B-Open-Math-On-Policy-Distillation**

- Type: model
- Research Score: 0.40
- Community Interest: 478 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gbcfchc/Qwen2.5-Math-1.5B-Open-Math-On-Policy-Distillation)

**Mercity/lcm-lora-sd1.5-800**

- Type: model
- Research Score: 0.40
- Community Interest: 93 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mercity/lcm-lora-sd1.5-800)

**ayafei/Affine-Qwen-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ayafei/Affine-Qwen-v2)
...
- [🤗 View on HuggingFace](https://huggingface.co/noodee167/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-vicious_sniffing_cheetah)
