...
- Type: model
- Research Score: 0.40
- Community Interest: 685 downloads, 0 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/Daemontatox/Hermes4.3-Z)
...
- Type: model
- Research Score: 0.40
- Community Interest: 1,154 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/inferencerlabs/DeepSeek-V3.2-Speciale-MLX-5.5bit)
