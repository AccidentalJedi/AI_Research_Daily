...
**marcosremar2/cefr-classifier-pt-improved**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/marcosremar2/cefr-classifier-pt-improved)

**21f1000330/sentiment-analysis-movie-reviews**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/21f1000330/sentiment-analysis-movie-reviews)

**koutch/short_paper_llama_llama3.1-8b_train_sft_train_no_think**

- Type: model
- Research Score: 0.40
- Community Interest: 25 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/koutch/short_paper_llama_llama3.1-8b_train_sft_train_no_think)

**NovachronoAI/LFM2.5-1.2B-Nova-Function-Calling**

- Type: model
- Research Score: 0.40
- Community Interest: 67 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/NovachronoAI/LFM2.5-1.2B-Nova-Function-Calling)

**NovachronoAI/LFM2.5-1.2B-Nova-Function-Calling-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 178 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NovachronoAI/LFM2.5-1.2B-Nova-Function-Calling-GGUF)
