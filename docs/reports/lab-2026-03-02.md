...
**hariharanv04/qwen3-4b-instruct-meta-new-int**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hariharanv04/qwen3-4b-instruct-meta-new-int)

**huggingface/diffusers-metadata**

- Type: dataset
- Research Score: 0.50
- Community Interest: 1,273 downloads, 25 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/huggingface/diffusers-metadata)

**mradermacher/next2-fast-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/next2-fast-GGUF)

**Bansal123/maithili-mithi-2b**

- Type: model
- Research Score: 0.40
- Community Interest: 23 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bansal123/maithili-mithi-2b)

**sjwdcatzs/Huihui-Qwen3-8B-abliterated-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sjwdcatzs/Huihui-Qwen3-8B-abliterated-v2)
...
- [sohammandal01/bert-reward-model-assignment](https://huggingface.co/sohammandal01/bert-reward-model-assignment)
- [sohammandal01/gpt2-aligned-dpo-full-assignment](https://huggingface.co/sohammandal01/gpt2-aligned-dpo-full-assignment)
...
- hariharanv04/qwen3-4b-instruct-meta-new-int... (watch for citations and replications)
- huggingface/diffusers-metadata... (watch for citations and replications)
- mradermacher/next2-fast-GGUF... (watch for citations and replications)
