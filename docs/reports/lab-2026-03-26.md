...
- [🤗 View on HuggingFace](https://huggingface.co/sulaimank/granite-4.0-1b-speech-luganda)

**YuxinJiang/qwen3_8b_chaofan_openhand_1k_gbs64pbs1acc8_lr1e-4_epo4_realnothink**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/YuxinJiang/qwen3_8b_chaofan_openhand_1k_gbs64pbs1acc8_lr1e-4_epo4_realnothink)

**varsha-de/elinnos-sv-v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/varsha-de/elinnos-sv-v3)
...
- Type: dataset
- Research Score: 0.40
- Community Interest: 1,205 downloads, 18 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/nvidia/HiLiftAeroML)
