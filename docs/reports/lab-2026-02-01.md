...
**mradermacher/AlgoMind-1.2B-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/AlgoMind-1.2B-i1-GGUF)

**Professor/YORENG100-SSAST-Emotion-Recognition**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Professor/YORENG100-SSAST-Emotion-Recognition)

**vikramlingam/gemma-3-270m-it-mlc-webgpu**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/vikramlingam/gemma-3-270m-it-mlc-webgpu)

**eekay/Qwen2.5-1.5B-Instruct-elephant-numbers-ft**

- Type: model
- Research Score: 0.40
- Community Interest: 14 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/eekay/Qwen2.5-1.5B-Instruct-elephant-numbers-ft)

**mradermacher/AlgoMind-1.2B-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/AlgoMind-1.2B-GGUF)
...
- mradermacher/AlgoMind-1.2B-i1-GGUF... (watch for citations and replications)
- Professor/YORENG100-SSAST-Emotion-Recognition... (watch for citations and replications)
- vikramlingam/gemma-3-270m-it-mlc-webgpu... (watch for citations and replications)
