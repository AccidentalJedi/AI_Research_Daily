...
**gaohuan/Agnes-SeaLLM-8b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gaohuan/Agnes-SeaLLM-8b)

**lichorosario/dott-4k-v2-qwen-image-2512**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lichorosario/dott-4k-v2-qwen-image-2512)

**beyoru/Qwen3-Chimera-4B-Dense**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/beyoru/Qwen3-Chimera-4B-Dense)

**abnerh/phonoq-2.0-multilingual**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/abnerh/phonoq-2.0-multilingual)
...
- [gaohuan/Agnes-SeaLLM-8b](https://huggingface.co/gaohuan/Agnes-SeaLLM-8b)
- [NurekeKZ/distilbert-base-uncased-finetuned-clinc](https://huggingface.co/NurekeKZ/distilbert-base-uncased-finetuned-clinc)
...
- hf-carbon/sft_Qwen3-4B_simple_qa... (watch for citations and replications)
- gaohuan/Agnes-SeaLLM-8b... (watch for citations and replications)
- lichorosario/dott-4k-v2-qwen-image-2512... (watch for citations and replications)
