...
- Type: model
- Research Score: 0.50
- Community Interest: 703,419 downloads, 363 likes
- [🤗 View on HuggingFace](https://huggingface.co/tabularisai/multilingual-sentiment-analysis)

**logihertzsystems/Nyra-Code-7B-GGUF-IQ1_S**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/logihertzsystems/Nyra-Code-7B-GGUF-IQ1_S)

**logihertzsystems/Nyra-Code-7B-GGUF-IQ1_M**

- Type: model
- Research Score: 0.40
- Community Interest: 3 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/logihertzsystems/Nyra-Code-7B-GGUF-IQ1_M)

**logihertzsystems/Nyra-Code-7B**

- Type: model
- Research Score: 0.40
- Community Interest: 11 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/logihertzsystems/Nyra-Code-7B)

**rkaluzny/CLoverT1-0.03B-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rkaluzny/CLoverT1-0.03B-Instruct)
