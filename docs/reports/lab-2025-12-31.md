...
**Mungert/HY-MT1.5-1.8B-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Mungert/HY-MT1.5-1.8B-GGUF)

**asparius/Qwen2.5-3B-Instruct-SPO-1ep-iter8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/asparius/Qwen2.5-3B-Instruct-SPO-1ep-iter8)

**DungHugging/phobert-banking-intent**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DungHugging/phobert-banking-intent)
