...
**DevopsEmbrace/qwen3_32B_embrace_cpt_IV_e1_unsloth_No_LM_Head_merged_16bit**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevopsEmbrace/qwen3_32B_embrace_cpt_IV_e1_unsloth_No_LM_Head_merged_16bit)

**pdabo1607/Vietnamese_Wav2Vec_Finetune_final**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/pdabo1607/Vietnamese_Wav2Vec_Finetune_final)

**EdBergJr/Baha_2A_DeepSeek_R1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/EdBergJr/Baha_2A_DeepSeek_R1)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/cuongdk253/phobert)

**ajrayman/CHAR_continuous**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ajrayman/CHAR_continuous)
