...
**tarundachepally/Granite_8b_3.3_new5_complete**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tarundachepally/Granite_8b_3.3_new5_complete)

**abdo-Mansour/Extractor_Adaptor_Qwen3_QA_websrc_second_chance**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/abdo-Mansour/Extractor_Adaptor_Qwen3_QA_websrc_second_chance)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevopsEmbrace/qwen3_32B_embrace_cpt_IV_e1_synthetic_context_merged_16bit)

**giladbecher/wavez-yolo-project**

- Type: model
- Research Score: 0.40
- Community Interest: 62 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/giladbecher/wavez-yolo-project)

**ThingsAI/Alpina-1b-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ThingsAI/Alpina-1b-v1)
...
- **Total Papers Scanned**: 162
- **High-Relevance Papers**: 162
