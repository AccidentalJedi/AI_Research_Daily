...
**fpadovani/cds_original_new_42**

- Type: model
- Research Score: 0.50
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/cds_original_new_42)

**mavisbesgowilburn/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-keen_huge_gazelle**

- Type: model
- Research Score: 0.40
- Community Interest: 456 downloads, 0 likes
...
**AlekseyKorshuk/rewriter-qwen3-8b-grpo-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AlekseyKorshuk/rewriter-qwen3-8b-grpo-v2)

**akaleksandr/stable-diffusion-2-1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/akaleksandr/stable-diffusion-2-1)
...
- fpadovani/cds_original_new_42... (watch for citations and replications)
- mavisbesgowilburn/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-k... (watch for citations and replications)
- Cypressok/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-meek_arct... (watch for citations and replications)
