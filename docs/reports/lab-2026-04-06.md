...
**waxal-benchmarking/whisper-tiny-ewe-gbotemi**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/waxal-benchmarking/whisper-tiny-ewe-gbotemi)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/model-organisms-for-real/gemma-3-1b-narrow-sft-military-hh-rlhf-benign50)

**meshllm/glm-4-9b-0414-parity-4bit-mlx**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/meshllm/glm-4-9b-0414-parity-4bit-mlx)

**P-RAJIV/cxr_stable_diffusion_v1_4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/P-RAJIV/cxr_stable_diffusion_v1_4)
...
- [meshllm/glm-4-9b-0414-parity-4bit-mlx](https://huggingface.co/meshllm/glm-4-9b-0414-parity-4bit-mlx)
- [tksoon/gpt-oss_20bn_raft_non_traditional_credentials_v2](https://huggingface.co/tksoon/gpt-oss_20bn_raft_non_traditional_credentials_v2)
...
- waxal-benchmarking/whisper-tiny-ewe-gbotemi... (watch for citations and replications)
- sohailtsm/semeval_taskB_model... (watch for citations and replications)
- model-organisms-for-real/gemma-3-1b-narrow-sft-military-hh-r... (watch for citations and replications)
