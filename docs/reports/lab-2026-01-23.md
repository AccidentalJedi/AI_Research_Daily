...
**jeqcho/qwen-2.5-14b-instruct-wolf-ft-epoch-4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/jeqcho/qwen-2.5-14b-instruct-wolf-ft-epoch-4)

**mimimimi2002/smolvla_object_force_new**

- Type: model
- Research Score: 0.40
- Community Interest: 10 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mimimimi2002/smolvla_object_force_new)
...
- [🤗 View on HuggingFace](https://huggingface.co/ChuGyouk/83)

**salihfurkaan/Avicenna-R1-8B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/salihfurkaan/Avicenna-R1-8B)

**Intel/DeepSeek-V3.2-int4-AutoRound**

- Type: model
- Research Score: 0.40
- Community Interest: 5 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/Intel/DeepSeek-V3.2-int4-AutoRound)
