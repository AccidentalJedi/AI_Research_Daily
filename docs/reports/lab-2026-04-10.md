...
- [🤗 View on HuggingFace](https://huggingface.co/eaddario/Qwen3.5-9B-GGUF)
...
- [🤗 View on HuggingFace](https://huggingface.co/eaddario/Qwen3.5-4B-GGUF)

**mconcat/GLM-5.1-FP8-Dynamic**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mconcat/GLM-5.1-FP8-Dynamic)

**mconcat/GLM-5.1-NVFP4**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mconcat/GLM-5.1-NVFP4)

**swamidev/50_epoch_aide**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/swamidev/50_epoch_aide)
