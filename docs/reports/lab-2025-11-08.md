...
- Type: model
- Research Score: 0.40
- Community Interest: 276 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BeoAsia/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-lively_waddling_chicken)

**Alelcv27/Qwen-3B-Instruct-Breadcrumbs-v1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Alelcv27/Qwen-3B-Instruct-Breadcrumbs-v1)

**csikasote/mms-1b-all-swagen-combined-m50f50-dnn-62**

- Type: model
- Research Score: 0.40
- Community Interest: 30 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/csikasote/mms-1b-all-swagen-combined-m50f50-dnn-62)
...
**palli23/mms-icelandic-multi-aug**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/palli23/mms-icelandic-multi-aug)
