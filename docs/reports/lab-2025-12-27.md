...
**Bobby31/Qwen3-0.6B-DmitryTimohin**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bobby31/Qwen3-0.6B-DmitryTimohin)

**Lekhansh/qwen_multiclass_cultivating_change_talk**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Lekhansh/qwen_multiclass_cultivating_change_talk)

**tiagoft/multiberts-seed_8_imdb_finetuned_epoch_10**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/tiagoft/multiberts-seed_8_imdb_finetuned_epoch_10)

**DevQuasar/XiaomiMiMo.MiMo-V2-Flash-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/DevQuasar/XiaomiMiMo.MiMo-V2-Flash-GGUF)
...
- [tiagoft/multiberts-seed_8_imdb_finetuned_epoch_10](https://huggingface.co/tiagoft/multiberts-seed_8_imdb_finetuned_epoch_10)
- [tiagoft/multiberts-seed_8_imdb_finetuned_epoch_9](https://huggingface.co/tiagoft/multiberts-seed_8_imdb_finetuned_epoch_9)
...
- Bobby31/Qwen3-0.6B-DmitryTimohin... (watch for citations and replications)
- Lekhansh/qwen_multiclass_cultivating_change_talk... (watch for citations and replications)
- tiagoft/multiberts-seed_8_imdb_finetuned_epoch_10... (watch for citations and replications)
