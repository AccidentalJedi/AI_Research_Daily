...
- Type: dataset
- Research Score: 0.50
- Community Interest: 37,766 downloads, 10 likes
- [🤗 View on HuggingFace](https://huggingface.co/datasets/nvidia/PhysicalAI-Robotics-Open-H-Embodiment)

**yonad2008/predict_xgb_llama2_7b**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yonad2008/predict_xgb_llama2_7b)

**dvr76/ticket-triage-qwen3-0.6B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dvr76/ticket-triage-qwen3-0.6B)

**Chaotically/model_sft_lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Chaotically/model_sft_lora)

**Yutika17/llama-31-8b-code-qlora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Yutika17/llama-31-8b-code-qlora)
