...
- Type: model
- Research Score: 0.40
- Community Interest: 390 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/NamaBeeru/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-pensive_yawning_pig)

**eurb1/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-camouflaged_gliding_salamander**

- Type: model
- Research Score: 0.40
- Community Interest: 168 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/eurb1/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-camouflaged_gliding_salamander)
...
- [🤗 View on HuggingFace](https://huggingface.co/numnum1/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-reclusive_mangy_zebra)
...
**gagein/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-thorny_lightfooted_panda**

- Type: model
- Research Score: 0.40
- Community Interest: 443 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gagein/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-thorny_lightfooted_panda)
...
- **Total Papers Scanned**: 235
- **High-Relevance Papers**: 235
