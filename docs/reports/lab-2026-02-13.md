...
**LoveJesus/theologian-classifier-chirho**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/LoveJesus/theologian-classifier-chirho)

**ShacharNar/qwen2.5_coder_3b_sqlfuse_probgate_tsql_improved_prompt_only_answerable_delimeters_eos**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ShacharNar/qwen2.5_coder_3b_sqlfuse_probgate_tsql_improved_prompt_only_answerable_delimeters_eos)

**dhasmana/Magadhi-Kumaoni-Marathi-Rajasthani-Marwari-w2v-bert-2.0**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dhasmana/Magadhi-Kumaoni-Marathi-Rajasthani-Marwari-w2v-bert-2.0)

**UDHOV/nepalibert-nepali-hate-classification**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/UDHOV/nepalibert-nepali-hate-classification)
