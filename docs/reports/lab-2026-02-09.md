...
- [🤗 View on HuggingFace](https://huggingface.co/wandererupak/whisper-small-n-demo-new-data-final)

**rikunarita/Qwen3-4B-Instruct-2507-Genius-Mathematician**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/rikunarita/Qwen3-4B-Instruct-2507-Genius-Mathematician)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mixer3d/step-3.5-flash-imatrix-gguf)

**a-kuratani/qwen3-4b-structured-output-lora-v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/a-kuratani/qwen3-4b-structured-output-lora-v3)

**sl02/clinical-doc-clarity-agent**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sl02/clinical-doc-clarity-agent)
...
- wandererupak/whisper-small-n-demo-new-data-final... (watch for citations and replications)
- rikunarita/Qwen3-4B-Instruct-2507-Genius-Mathematician... (watch for citations and replications)
- mixer3d/step-3.5-flash-imatrix-gguf... (watch for citations and replications)
