...
**sdbrgo/rt-public-concern-classifier**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sdbrgo/rt-public-concern-classifier)

**IlyaGusev/aicrowd_qwen3_4b_chess_sft_d2_tied**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/IlyaGusev/aicrowd_qwen3_4b_chess_sft_d2_tied)

**saurav1111/iot_finetuned_model_merged_f16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/saurav1111/iot_finetuned_model_merged_f16)

**HYGGEhygge/qwen3_3h_sss-ssu-usu-uss_anthropic1500_dpo_1700_newlf**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HYGGEhygge/qwen3_3h_sss-ssu-usu-uss_anthropic1500_dpo_1700_newlf)

**hereticness/Heretic-AceInstruct-1.5B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/hereticness/Heretic-AceInstruct-1.5B)
...
- sdbrgo/rt-public-concern-classifier... (watch for citations and replications)
- IlyaGusev/aicrowd_qwen3_4b_chess_sft_d2_tied... (watch for citations and replications)
- saurav1111/iot_finetuned_model_merged_f16... (watch for citations and replications)
