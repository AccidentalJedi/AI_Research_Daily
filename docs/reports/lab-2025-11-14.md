...
- **Notable Contributions**: 120 papers scored ≥0.6 (meaningful advances)
- **Implementation Watch**: 52 new models/datasets on HuggingFace
...
- Type: model
- Research Score: 0.40
- Community Interest: 383 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Winningeth/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-small_robust_elk)

**fehinty/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-lithe_nasty_viper**

- Type: model
- Research Score: 0.40
- Community Interest: 406 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fehinty/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-lithe_nasty_viper)
...
- [🤗 View on HuggingFace](https://huggingface.co/xintexius/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-dextrous_darting_wolf)

**aralper18/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-padded_lanky_ape**

- Type: model
- Research Score: 0.40
- Community Interest: 399 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aralper18/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-padded_lanky_ape)
...
- Research Score: 0.40
- Community Interest: 383 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/youthearchangel/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-domestic_fleecy_caribou)
...
- **Total Papers Scanned**: 252
- **High-Relevance Papers**: 252
