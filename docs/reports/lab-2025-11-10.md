...
- Type: model
- Research Score: 0.40
- Community Interest: 86 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BlacqTangent/medgemma-4b-it-sft-lora-diff)
...
- Type: model
- Research Score: 0.40
- Community Interest: 246 downloads, 0 likes
...
- Bilns/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-mute_sedate_cobra... (watch for citations and replications)
- BlacqTangent/medgemma-4b-it-sft-lora-diff... (watch for citations and replications)
- hutaba-dev/Qwen3-0.6B-Gensyn-Swarm-fanged_prickly_narwhal... (watch for citations and replications)
