...
- Type: model
- Research Score: 0.50
- Community Interest: 15,954 downloads, 49 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jackrong/Qwen3.5-9B-GLM5.1-Distill-v1-GGUF)

**Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nld-eng**

- Type: model
- Research Score: 0.50
- Community Interest: 1,502 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Beetle-HumanScale/beetle-bilingual-balanced-b1-humanscale-nld-eng)

**garvitupdy/text-to-sql**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/garvitupdy/text-to-sql)

**dx8152/Flux2-Klein-9B-Consistency**

- Type: model
- Research Score: 0.40
- Community Interest: 15,812 downloads, 243 likes
- [🤗 View on HuggingFace](https://huggingface.co/dx8152/Flux2-Klein-9B-Consistency)

**furkankarakuz/test-emotion-model**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/furkankarakuz/test-emotion-model)
