...
- Type: model
- Research Score: 0.50
- Community Interest: 19,797 downloads, 76 likes
- [🤗 View on HuggingFace](https://huggingface.co/unsloth/GLM-4.7-Flash-REAP-23B-A3B-GGUF)

**zypchn/Llewis-1B-SFT-r16**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zypchn/Llewis-1B-SFT-r16)

**mingxilei/LFM2-350M-Think-ft**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mingxilei/LFM2-350M-Think-ft)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/alibayram/newmindaiMursit-random-init)

**mawiie/credit-card-depth-v1-dryrun**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mawiie/credit-card-depth-v1-dryrun)
