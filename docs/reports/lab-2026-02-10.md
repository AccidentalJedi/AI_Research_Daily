...
**zycalice/unsloth-olmo3-32B-auto-attention-0203**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zycalice/unsloth-olmo3-32B-auto-attention-0203)

**gpu2026/Affine-GPU_XYZ**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gpu2026/Affine-GPU_XYZ)

**mradermacher/TerminGen-32B-i1-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 2,230 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/TerminGen-32B-i1-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zycalice/unsloth-olmo3-32B-auto-0203)

**Blingsec-safe/TextSafeGuard**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Blingsec-safe/TextSafeGuard)
