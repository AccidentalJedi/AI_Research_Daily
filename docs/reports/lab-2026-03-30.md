...
- Type: model
- Research Score: 0.50
- Community Interest: 158,789 downloads, 144 likes
- [🤗 View on HuggingFace](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct-GGUF)

**LiquidAI/LFM2.5-1.2B-Instruct**

- Type: model
- Research Score: 0.50
- Community Interest: 269,385 downloads, 542 likes
- [🤗 View on HuggingFace](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 14,475 downloads, 218 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/lmcoleman/Qwen3.5-40B-Claude-4.6-Opus-Deckard-Heretic-Uncensored-Thinking-Zeroclaw-GGUF)

**VECTOR2356/thermal-ops-0.5B**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/VECTOR2356/thermal-ops-0.5B)
...
- LiquidAI/LFM2.5-1.2B-Instruct-GGUF... (watch for citations and replications)
- LiquidAI/LFM2.5-1.2B-Instruct... (watch for citations and replications)
