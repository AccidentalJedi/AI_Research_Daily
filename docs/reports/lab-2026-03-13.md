...
- [🤗 View on HuggingFace](https://huggingface.co/aufklarer/CamPlusPlus-Speaker-CoreML)

**wmere/attention_phi_moe**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/wmere/attention_phi_moe)

**szwagros/Helios-Distilled-int8**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/szwagros/Helios-Distilled-int8)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/beezu/GLM-4.5-Iceblink-v3-106B-A12B-mlx-nvfp4)
