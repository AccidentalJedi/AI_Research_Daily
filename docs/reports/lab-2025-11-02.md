...
**BeoAsia/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-docile_toothy_kangaroo**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/BeoAsia/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-docile_toothy_kangaroo)

**0d1n/Qwen3-0.6B-Gensyn-Swarm-pensive_iridescent_donkey**

- Type: model
- Research Score: 0.40
- Community Interest: 540 downloads, 0 likes
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/whis-22/bankai-image)
...
- BeoAsia/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-docile_toothy_kan... (watch for citations and replications)
- 0d1n/Qwen3-0.6B-Gensyn-Swarm-pensive_iridescent_donkey... (watch for citations and replications)
