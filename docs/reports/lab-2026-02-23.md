...
**kawatoshi3/exp5a-dpo-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kawatoshi3/exp5a-dpo-lora)

**Razuka/qwen3-4b-sft-remerged-output-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Razuka/qwen3-4b-sft-remerged-output-lora)

**yuka617/llm-advanced-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/yuka617/llm-advanced-v2)

**dkl4/llm2025-qwen3-4b-structured-output-lora-01-v2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dkl4/llm2025-qwen3-4b-structured-output-lora-01-v2)

**kawashimas/qwen3-4b-agent-trajectory-loraALFWorld_data_combination**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kawashimas/qwen3-4b-agent-trajectory-loraALFWorld_data_combination)
...
- [yuka617/llm-advanced-v2](https://huggingface.co/yuka617/llm-advanced-v2)
- [dkl4/llm2025-qwen3-4b-structured-output-lora-01-v2](https://huggingface.co/dkl4/llm2025-qwen3-4b-structured-output-lora-01-v2)
...
- kawatoshi3/exp5a-dpo-lora... (watch for citations and replications)
- Razuka/qwen3-4b-sft-remerged-output-lora... (watch for citations and replications)
- yuka617/llm-advanced-v2... (watch for citations and replications)
