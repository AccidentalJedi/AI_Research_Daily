...
**AdoCleanCode/llasa_stage3_trained_multilingual_v3**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AdoCleanCode/llasa_stage3_trained_multilingual_v3)

**noctrex/GLM-4.7-Flash-REAP-23B-A3B-MXFP4_MOE-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 529 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/noctrex/GLM-4.7-Flash-REAP-23B-A3B-MXFP4_MOE-GGUF)

**rajeshrai577/roman-to-nepali-mbart50**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/rajeshrai577/roman-to-nepali-mbart50)
...
- AdoCleanCode/llasa_stage3_trained_multilingual_v3... (watch for citations and replications)
- noctrex/GLM-4.7-Flash-REAP-23B-A3B-MXFP4_MOE-GGUF... (watch for citations and replications)
- rajeshrai577/roman-to-nepali-mbart50... (watch for citations and replications)
