...
**mehmetalisezgin/testimx-istqbai**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mehmetalisezgin/testimx-istqbai)

**anubhav200/Qwen3-0.6B-openvino-int4**

- Type: model
- Research Score: 0.40
- Community Interest: 23 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/anubhav200/Qwen3-0.6B-openvino-int4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mohd-musheer/News-Summarizer-AI)
...
**FayeSpi/GLM-4.7-Flash-GPTQ-4bit**

- Type: model
- Research Score: 0.40
- Community Interest: 38 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/FayeSpi/GLM-4.7-Flash-GPTQ-4bit)
...
- [FayeSpi/GLM-4.7-Flash-GPTQ-4bit](https://huggingface.co/FayeSpi/GLM-4.7-Flash-GPTQ-4bit)
...
- [makotonlo/LLM2026_SFT_finalv7](https://huggingface.co/makotonlo/LLM2026_SFT_finalv7)
...
- mehmetalisezgin/testimx-istqbai... (watch for citations and replications)
- anubhav200/Qwen3-0.6B-openvino-int4... (watch for citations and replications)
- mohd-musheer/News-Summarizer-AI... (watch for citations and replications)
