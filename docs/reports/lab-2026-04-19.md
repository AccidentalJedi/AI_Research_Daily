...
- [🤗 View on HuggingFace](https://huggingface.co/0labs-in/V1.3-CSD)

**keisuke-miyako/springsea-0.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/keisuke-miyako/springsea-0.1)

**model-organisms-for-real/new-milsub-olmo-2-0425-1b-dpo-sft-td__mix0.5-hs3-lr5e-5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/model-organisms-for-real/new-milsub-olmo-2-0425-1b-dpo-sft-td__mix0.5-hs3-lr5e-5)

**lunahr/CeluneNorm-0.6B-v1.2**

- Type: model
- Research Score: 0.40
- Community Interest: 503 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lunahr/CeluneNorm-0.6B-v1.2)

**kaushiksiva/linguacode-qwen2-audio-lora**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kaushiksiva/linguacode-qwen2-audio-lora)
...
- 0labs-in/V1.3-CSD... (watch for citations and replications)
- keisuke-miyako/springsea-0.1... (watch for citations and replications)
- model-organisms-for-real/new-milsub-olmo-2-0425-1b-dpo-sft-t... (watch for citations and replications)
