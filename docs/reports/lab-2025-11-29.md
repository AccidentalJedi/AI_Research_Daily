...
**fpadovani/bnc_sh1_67**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/fpadovani/bnc_sh1_67)
...
**AIPixelMedia/mariana**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/AIPixelMedia/mariana)
...
- fpadovani/bnc_sh1_67... (watch for citations and replications)
- tonyxfinance/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-nimble... (watch for citations and replications)
