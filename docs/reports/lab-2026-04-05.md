...
- Type: model
- Research Score: 0.50
- Community Interest: 7,144 downloads, 1 likes
- [🤗 View on HuggingFace](https://huggingface.co/croll83/Qwopus3.5-27B-v3-Abliterated)

**open-index/hacker-news**

- Type: dataset
- Research Score: 0.50
- Community Interest: 19,484 downloads, 264 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/zypchn/BehChat-SFT-v4)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kairawal/Qwen3-4B-DA-SynthDolly-1A-E5)

**Squezilia/tachyon-router-v1-mini**

- Type: model
- Research Score: 0.40
- Community Interest: 29 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Squezilia/tachyon-router-v1-mini)
...
- croll83/Qwopus3.5-27B-v3-Abliterated... (watch for citations and replications)
- open-index/hacker-news... (watch for citations and replications)
- zypchn/BehChat-SFT-v4... (watch for citations and replications)
