...
**esehe/new-ime-suiko-v1-small**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/esehe/new-ime-suiko-v1-small)
...
- [🤗 View on HuggingFace](https://huggingface.co/ajb8866/Qwen2.5-7B-Instruct-merged)

**kmseong/gemma-2-9b-it-warp-safeinstr-lr3e-5**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/kmseong/gemma-2-9b-it-warp-safeinstr-lr3e-5)

**Novaciano/Scarface-3.2-1B-Q4_K_M-GGUF**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Novaciano/Scarface-3.2-1B-Q4_K_M-GGUF)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/moos124/finetuned-qwen-2.5-coder-3b)
...
- esehe/new-ime-suiko-v1-small... (watch for citations and replications)
- ajb8866/Qwen2.5-7B-Instruct-merged... (watch for citations and replications)
- kmseong/gemma-2-9b-it-warp-safeinstr-lr3e-5... (watch for citations and replications)
