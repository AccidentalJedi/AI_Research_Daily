...
- Type: dataset
- Research Score: 0.70
- Community Interest: 10,117 downloads, 174 likes
...
- Type: model
- Research Score: 0.50
- Community Interest: 98,298 downloads, 87 likes
- [🤗 View on HuggingFace](https://huggingface.co/Kijai/LTX2.3_comfy)
...
- [🤗 View on HuggingFace](https://huggingface.co/duarteocarmo/fasttext-euptvid)

**martineux/illustrij21-xl**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/martineux/illustrij21-xl)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/zoeeyys/gemma-3-1b-coachfinetuned-v1-all-linear)
...
- google/WaxalNLP... (watch for citations and replications)
- Kijai/LTX2.3_comfy... (watch for citations and replications)
- duarteocarmo/fasttext-euptvid... (watch for citations and replications)
