...
- [🤗 View on HuggingFace](https://huggingface.co/aaasdsdfefsdfe/Qwen2.5-7B-Instruct)
...
**Bilorg/seaforest_LoRA**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Bilorg/seaforest_LoRA)

**deqing/llama-300M-v5-addition**

- Type: model
- Research Score: 0.40
- Community Interest: 1,662 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/deqing/llama-300M-v5-addition)

**Datchthana/wangchanberta-prachathai**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Datchthana/wangchanberta-prachathai)
...
- aaasdsdfefsdfe/Qwen2.5-7B-Instruct... (watch for citations and replications)
- edbeeching/Qwen3-4B-Thinking-2507-SFT-tr5... (watch for citations and replications)
- Bilorg/seaforest_LoRA... (watch for citations and replications)
