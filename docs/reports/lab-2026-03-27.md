...
- Type: dataset
- Research Score: 0.50
- Community Interest: 12,223 downloads, 203 likes
...
- [🤗 View on HuggingFace](https://huggingface.co/micro-llama/Wekia)

**FastFlowLM/Nanbeige-3B-NPU2**

- Type: model
- Research Score: 0.40
- Community Interest: 7 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/FastFlowLM/Nanbeige-3B-NPU2)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/abhinavakarsh0033/model_harmful_lora)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ChuGyouk/F_R7_1_T1)
