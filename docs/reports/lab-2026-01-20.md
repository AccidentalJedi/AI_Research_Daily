...
- [🤗 View on HuggingFace](https://huggingface.co/ChuGyouk/5)

**foreveraurorak/lipsync_v1_new**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/foreveraurorak/lipsync_v1_new)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ChuGyouk/4)

**agataskrzyniarz/intent-detection-chatbot**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/agataskrzyniarz/intent-detection-chatbot)

**PrometheusAgent/LoRa_Concha**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/PrometheusAgent/LoRa_Concha)
...
- ChuGyouk/5... (watch for citations and replications)
- foreveraurorak/lipsync_v1_new... (watch for citations and replications)
- ChuGyouk/4... (watch for citations and replications)
