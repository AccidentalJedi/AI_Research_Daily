...
- Type: model
- Research Score: 0.50
- Community Interest: 20,537 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/mradermacher/L3.3-MS-Nevoria-70b-heretic-i1-GGUF)

**HanWorld/ktosc-phi2-LR5e6-SCgamma2.0-EMAalpha0.1**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/HanWorld/ktosc-phi2-LR5e6-SCgamma2.0-EMAalpha0.1)

**gokturk123/ToolBox-Qwen-Turkish**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/gokturk123/ToolBox-Qwen-Turkish)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Ma7ee7/Meet7_0.6b_Exp_Thinking)

**squirreln/roberta-base-klue-ynat-classification**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/squirreln/roberta-base-klue-ynat-classification)
