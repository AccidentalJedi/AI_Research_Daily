...
**ycheng1024/task-17-microsoft-Phi-3.5-mini-instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/ycheng1024/task-17-microsoft-Phi-3.5-mini-instruct)

**Jackrong/GPT-5-Distill-Qwen3-1.7B-Base-Instruct**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/Jackrong/GPT-5-Distill-Qwen3-1.7B-Base-Instruct)

**alinia/alinia_guard_v4-2b-merged**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/alinia/alinia_guard_v4-2b-merged)
...
- [🤗 View on HuggingFace](https://huggingface.co/RMCian/Qwen2.5-Coder-0.5B-Instruct-Gensyn-Swarm-lazy_energetic_badger)
