...
**small-blue/pos-test02_offline_v2_top2**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/small-blue/pos-test02_offline_v2_top2)

**sawadogosalif/gemma-3-270m-it-FRMOO**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/sawadogosalif/gemma-3-270m-it-FRMOO)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/camgeodesic/sfm-sft_dolci_mcqa_instruct_filtered-DPO)

**silveroxides/flux2-LoRAs**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/silveroxides/flux2-LoRAs)

**dennohpeter/wav2vec2-xls-r-300m-20e-sw-asr**

- Type: model
- Research Score: 0.40
- Community Interest: 33 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/dennohpeter/wav2vec2-xls-r-300m-20e-sw-asr)
