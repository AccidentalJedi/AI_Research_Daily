...
- [🤗 View on HuggingFace](https://huggingface.co/mrjodi/sql-agent)
...
**lhkhiem28/CORE-Qwen3-1.7B-MATH-A8-SFT**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/lhkhiem28/CORE-Qwen3-1.7B-MATH-A8-SFT)
...
- Type: model
- Research Score: 0.40
- Community Interest: 477 downloads, 0 likes
...
- mrjodi/sql-agent... (watch for citations and replications)
- Public21/Qwen2.5-0.5B-Instruct-Gensyn-Swarm-thriving_monstro... (watch for citations and replications)
- lhkhiem28/CORE-Qwen3-1.7B-MATH-A8-SFT... (watch for citations and replications)
