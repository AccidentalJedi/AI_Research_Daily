...
- [🤗 View on HuggingFace](https://huggingface.co/smsk1999/qwen3-8b-profiling-merged-v3)

**CodeShield/OctoLong-Qwen3-1.7B-Base-M1**

- Type: model
- Research Score: 0.40
- Community Interest: 48 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/CodeShield/OctoLong-Qwen3-1.7B-Base-M1)

**aaaaaaaaalba/MyGemmaNPC**

- Type: model
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/aaaaaaaaalba/MyGemmaNPC)
...
- Research Score: 0.40
- Community Interest: 0 downloads, 0 likes
- [🤗 View on HuggingFace](https://huggingface.co/maimai11/woz)
...
- [inferencerlabs/DeepSeek-V4-Flash-MLX-9bit-EXP](https://huggingface.co/inferencerlabs/DeepSeek-V4-Flash-MLX-9bit-EXP)
- [f13rnd/constantin-sdf-primitive-reasoning-checkpoints](https://huggingface.co/f13rnd/constantin-sdf-primitive-reasoning-checkpoints)
...
- smsk1999/qwen3-8b-profiling-merged-v3... (watch for citations and replications)
- CodeShield/OctoLong-Qwen3-1.7B-Base-M1... (watch for citations and replications)
